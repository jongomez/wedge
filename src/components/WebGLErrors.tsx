...
export function WebGLNotSupported({ }: WebGLNotSupportedProps) {
  return (
    ...
    >
      ...
      <p style={styles.textParagraph}>Simply refreshing the page may work in certain cases.</p>
      <p style={styles.textParagraph}>
        If refreshing does not work, my suggestion would be to search online for &quot;How to enable webgl in &quot; followed by
