...
void main() {
  ...
  vec4 value1 = ${input1IsTextureArray ? `texelFetch(${input1.uniformName}, value1XYZ, 0)` : `${input1?.uniformName}`};
  vec4 value2 = ${input2IsTextureArray ? `texelFetch(${input2.uniformName}, value2XYZ, 0)` : `${input2?.uniformName}`};
